...
* complete 1 - 3 **explorations** in the textbook or provided on [D2L](https://ecat1.montana.edu/),
...
5. Midterm exams (25%): There will be two midterm exams (worth 12.5% each). **Midterm exam 1 must be taken on Monday, September 21st; Midterm exam 2 must be taken on Monday, October 26th.** Midterm exams will be taken in [Gradescope](https://www.gradescope.com/).  You will have 2 hours from the time you open the exam to complete it.  **Exams must be taken on the scheduled date.  You are responsible for arranging your schedule to accommodating taking of exams.** 
  + The midterm exams are intended as an opportunity for you to consolidate your knowledge from the first and second thirds of our course, so you are highly encouraged to take the exam using only your personal study materials. However, we rarely do statistics in a vacuum, so you will be allowed access to other students, the MLC, and your instructor for help with questions. You are NOT allowed to use other online resources (including D2L or Google - which may not be able to help you anyway. Blindly applying formulas you found through a search engine without understanding of the underlying statistical concepts will not help you on an exam question).  Upon starting the exam, you will be in a browser lock-down, meaning you will not be allowed to open any tabs except the Gradescope one with your exam.
6. Final Exam (20%): The final exam will be in a similar format as the two midterm exams and must be taken on  **Tuesday, November 24th**. 
