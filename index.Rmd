...
- Purchase WileyPlus Access. The lowest price option will come with access to the e-text but if you would prefer a loose-leaf or hard copy version of the textbook, there are options for that as well at varying additional costs (all options come with the e-text). WileyPlus also includes optional additional videos to watch (different from the mandatory videos you will view through D2L) as well as optional practice problems to work on as extra resources. If interested in this option, details are coming soon.
