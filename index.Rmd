...
### Required Textbook
The required textbook for the course is *Introduction to Statistical Investigations for Montana State University* by Tintle, Chance, Cobb, Rossman, Roy, Swanson, and VanderStoep (Wiley, 2016). MSU negotiated a reduced price for the textbook available only through the MSU bookstore. The e-textbook is required to access videos that will be assigned prior to each class period. The print textbook is optional, but access to [WileyPlus](https://education.wiley.com/ngonboard/index.html#/Login) is recommended. Other materials, such as readings and videos will be available in D2L. 
...
- [**WileyPlus**](https://education.wiley.com/ngonboard/index.html#/Login): Additional resources for the textbook.
...
1. D2L discussion (10%): Each week, you will answer questions on a reading, video, exploration, or provided relevant case study, posting answers and discussion in the D2L Discussion Forum.  Discussion posts will be due each **Sunday at 11pm MST**.
...
3. Explorations (10%): Explorations will primarily be in your textbook, though your instructor will provide some in [D2L](https://ecat1.montana.edu/) also.  Explorations will be due each **Thursday at 11pm MST**.
