...
2. [_STAT 216 Coursepack_]--- purchased through XanEdu. Can purchase the hard copy, a digital pdf or both.

CoursePack Title: Stat_216_Coursepack
ISBN: 9781711474120
CPID: 1511657

1. First things first, let's head over to the XanEdu "Login/Register" page. To get there, simply click on this link: https://connect.xanedu.com/.

2. If you've already registered for another CoursePack in the past, fantastic! Just log in using your existing account details. However, if this is your first time using XanEdu, no worries at all! Just click on the "Need an Account? Register Now" link. You'll be taken to a registration page where you can fill in your details. Once you're done, hit the Submit button to complete the registration process.

3. Sit tight for a moment after you've submitted your registration. Keep an eye on your email inbox. You should receive an email from "Your Friends at XanEdu". Go ahead and open it up, then click the link inside. This step is important as it verifies your account and allows you to set a password for added security.

4. You're almost there! Now that your account is all setup, it's time to access your desired CoursePack. Since you're logged in, navigate to the "Store" tab. There, you'll find a list of available CoursePacks. Click on the title of the specific pack you wish to purchase.

5. Great job! You've found your CoursePack. Now, simply click on the "Add to Cart" button. When you're ready to complete your purchase, click on the Cart icon. It's located in the top right corner of the page. Follow the prompts to finalize your purchase.

6. Congratulations on your successful purchase! Now, let's go back to your shelf. You'll notice that your newly acquired CoursePack is waiting for you there. Simply click on the pack's title, and voila! You'll gain access to all the incredible materials it contains.
