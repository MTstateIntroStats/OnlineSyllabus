...
**Braden Scherting**
email: bradenscherting@montana.edu  
...
[**Jing Zhang**](https://math.montana.edu/directory/faculty/2256996/jing-zhang){target="_blank"}  
email: jingzhang1@montana.edu  


---

## Section 804 and 805 Instructor
**Rachel Wyand**  
...
* STAT 216 calendar for students in online sections...
  - [First Summer Session](calendars/Sum1_21-Stat216_Calendar-Online.pdf)
  - [Second Summer Session](calendars/Sum2_21-Stat216_Calendar-Online.pdf)
...
The *Stat 216 Coursepack* of in-class activities is available for purchase in the [MSU Bookstore](https://www.msubookstore.org/). Students are expected to purchase the coursepack new for your Summer session course.
...
- [**Gradescope**](https://www.gradescope.com/): Submit and review assignments and exam grades. For more details, see our [Gradescope Help for Students](http://www.math.montana.edu/courses/s216/GradescopeHelpForStudents.pdf) document

- [**Math Learning Center**](https://math.montana.edu/undergrad/mlc/index.html): Free drop-in tutoring for 100- and 200-level math and stat courses.
...
* complete 1 - 3 **activities** in the coursepack,
* complete 2 **discussion posts** based on the week's content or a relevant case study,
...
grades$category <- fct_relevel(grades$category, "D2L discussion", "Video Quizzes", "Explorations", "Assignments", "Midterm exams (2)", "Group project")
...
grades %>% ggplot(aes(x=location, y=percent)) +
  ...
  geom_text(aes(x=rep(1, 6), 
                label=c("D2L discussion (10%)",
                        ...
                        "Midterm exams (30%)",
                        "Final exam (15%)"), 
                y=c(95,85,75,57.5,30,7.5))) + 
  labs(x='', y='Cumulative percent') + 
  theme(axis.text.x = element_blank()) +
  scale_fill_manual(values=pal)
```

1. D2L discussion (10%): Each week, you will either ask or answer questions on a reading, video, activity, or provided relevant case study, posting questions, answers and discussion in the D2L Discussion Forum.  Discussion posts will be due each **Wednesday at 8pm MST**.
2. Video quizzes (10%): You will be expected to complete the assigned textbook reading and videos prior to completing the activities(s) for each week. Each video will discuss the reading content and walk you through one or more examples for each section.   Treat these videos as your lecture on the textbook section, meaning you should actively be taking notes while watching the videos. Each video with have at least 3 multiple choice, fill-in-the-blank, or true/false questions embedded in it.  You may re-load the video to re-take the quiz and improve your score as many times as you like up through the due date.  All videos are linked in D2L and will be due each **Tuesday and Friday at 8am MST**.  Be sure to use the D2L checklists and course calendar to determine the due date for each video.
3. Activities (10%): Activities are located within the Stat 216 coursepack.  Activities will be due in Gradescope each **Friday at 8pm MST**.
4. Assignments (25%): You will complete bi-weekly assignments in [Gradescope](https://www.gradescope.com/).  Assignments will be due each **Monday and Thursday at 8pm MST**.
5. Midterm exams (30%): There will be two midterm exams (worth 15% each). Midterm 1 will be taken on the third Monday of each Summer Session and Midterm 2 will be taken on the final Thursday of each Summer Session.  Midterm exams will be taken in [Gradescope](https://www.gradescope.com/).  You will have 3 hours from the time you open the exam to complete it.  **Exams must be taken on the scheduled date.  You are responsible for arranging your schedule to accommodating taking of exams.** 
  + The midterm exams are intended as an opportunity for you to consolidate your knowledge from the first and second halfs of our course, so you are highly encouraged to take the exam using only your personal study materials. However, we rarely do statistics in a vacuum, so you will be allowed access to other students, the MLC, and your instructor for help with questions. You are NOT allowed to use other online \tutoring\ sites (such as Chegg). 
6. Group Project (15%): The project project will be completed in parts working with 2-3 other classmates.  You will be required to submit a research question and data collection plan, collect the data, and complete both a descriptive and inferential analysis of the data. You will turn in one project component per group each **Friday at 8pm**.

*Plan ahead*: In our experience, a 3-credit course over a 6 week summer session is expected to account for 75 minutes each day, 5 days per week to earn a good grade.  By “good” we mean at least a C because a grade of D or below does not count toward fulfilling degree requirements. Many of you set your goals higher than just getting a C, and we fully support that. You need roughly 6 to 8 hours per week to review past activities, read feedback on previous assignments, complete current assignments, and prepare for the next week's class. 
