...
2. [_STAT 216 Coursepack_](calendars/IntroStatActivities.pdf) --- our PDF workbook with reading guides and activities, free for Summer 2022 students.  You can also purchase a hard copy of the workbook for under $10 and have it shipped to you [here](https://www.lulu.com/en/us/shop/stacey-hancock-and-jade-schmidt-and-melinda-yager/stat-216-summer-coursepack/paperback/product-4z7m7g.html?page=1&pageSize=4).
...
- [**Gradescope**](https://www.gradescope.com/): Submit and review assignments, labs and exam grades. For more details, see our [Gradescope Help for Students](http://www.math.montana.edu/courses/s216/GradescopeHelpForStudents.pdf) document
...
* complete 1 - 4 **activities** in the coursepack,
* complete 2 **labs** in the coursepack,
...
Activities are located within the Stat 216 coursepack.  Activities will be *typically* due in Gradescope each **Tuesday and Thursday at 11pm MST**. Activities will be checked for completion. Be sure to use the D2L checklists and course calendar to determine the due date for each activity.

### Labs (15%)

Labs are located within the Stat 216 coursepack.  Labs will *typically* be due in Gradescope each **Tuesday and Thursday at 11pm MST**.  Labs should be used to check your understanding of the activities within each module and will be graded based on both completion and correctness.  Be sure to use the D2L checklists and course calendar to determine the due date for each lab.
