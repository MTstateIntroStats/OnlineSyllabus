...
### Required Textbook
The required textbook for the course is *Introduction to Statistical Investigations for Montana State University* by Tintle, Chance, Cobb, Rossman, Roy, Swanson, and VanderStoep (Wiley, 2016). 

Your three options for purchasing the textbook are as follows:

- Purchase WileyPlus Access. For those of you who are interested in the WileyPlus access, options start at \$69.00. Watch this [video](https://players.brightcove.net/4931690914001/default_default/index.html?videoId=6177746292001) for instructions. When you get to the 0:40 second mark, you should select "I don't have it" and then select "Using my instructor's name" and enter the first and last name of your instructor. The name should appear in a drop-down menu. Note: the video shows the options starting at \$99.00 but that's because it's for a different book. WileyPlus also includes optional additional videos to watch (different from the mandatory videos you will view through D2L) as well as optional practice problems to work on as extra resources. 

- Purchase just the e-text through the following [link](https://www.vitalsource.com/products/introduction-to-statistical-investigations-nathan-tintle-beth-l-chance-v9781119523819). Options start at $39.00.

- Purchase a loose-leaf or hard copy through some other retailer. You can use this [website](https://www.cheapesttextbooks.com/IM/?keyval=9781118172148&submit=1) that compares your different options.
    
Other materials, such as readings and videos will be available in D2L. 
